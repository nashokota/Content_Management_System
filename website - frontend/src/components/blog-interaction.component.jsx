...
const BlogInteraction = () => {
    ...
    const { _id = "", title = "", blog_id = "", activity = {}, author = { personal_info: { username: "" } } } = blog || {};
    ...
    useEffect(() => {
        ...
        if (access_token) {
            ...
            setIslikedByUser(blog?.activity?.islikedByUser || false);
        }
    }, [_id, access_token]);
                ...
                <div className="flex gap-6 items-center">
                    {username === author_username &&
                        <Link to={`/editor/${blog_id}`}>
                            <i className="fi fi-rr-edit text-xl underline hover:text-purple"></i>
                        </Link>
                    }
