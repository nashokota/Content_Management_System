  ...
  (function(a, s) {
    ...
    return function(a) {
      ...
      return r.m = a, r.c = s, r.d = function(o, e, d) {
        ...
        if (1 & e && (o = r(o)), 8 & e || 4 & e && typeof o == "object" && o && o.__esModule)
          return o;
        var d = /* @__PURE__ */ Object.create(null);
        if (r.r(d), Object.defineProperty(d, "default", { enumerable: true, value: o }), 2 & e && typeof o != "string")
          for (var v in o)
            r.d(d, v, (function(l) {
              return o[l];
            }).bind(null, v));
      ...
      (function(o) {
        ...
        function w(n) {
          ...
          for (var c = 0, u = n._deferreds.length; c < u; c++)
            f(n, n._deferreds[c]);
          n._deferreds = null;
        }
        function b(n, c, u) {
              ...
              try {
                if (E && (typeof E == "object" || typeof E == "function")) {
                  ...
                  if (typeof M == "function")
                    return void M.call(E, function(F) {
                      h(T, F);
                    }, u);
                }
                g[T] = E, --m == 0 && c(g);
      ...
      var e, d, v, l, f, p, y, w = r(8), b = (d = function(t) {
        ...
        if (t.headers = t.headers || {}, t.type && (typeof t.type != "string" || !Object.values(e).includes(t.type)))
        ...
        return t = l(t), w.selectFiles(t).then(function(n) {
          for (var c = new FormData(), u = 0; u < n.length; u++)
            c.append(t.fieldName, n[u], n[u].name);
      ...
      function l(u) {
        ...
        if ((r === d || !r) && setTimeout)
          return r = setTimeout, setTimeout(u, 0);
        try {
          return r(u, 0);
        } catch {
          try {
      ...
      var r = function(e) {
        ...
        return d = d || null, v = v || "&", l = l || null, e ? function(f) {
          ...
          var p, y, w = f;
          if (l && (w = l + "[" + w + "]"), typeof e[f] == "object" && e[f] !== null)
            p = o(e[f], null, v, w);
          else {
